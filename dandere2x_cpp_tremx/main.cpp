...
#define WRITE_DEBUG_FRAMES_VIDEO 0
    ...
    while (true) {
        ...
        for (int x=0; x < width_iterations; x++) {
            ...
            for (int y=0; y < height_iterations; y++) {
                ...
                raw_block_mse = 1; //calculate_mse(block_a, block_b);
...
int main(int argc, char** argv) {
    ...
    process_video(video_path, block_size, width, height, output_d2x_file, output_vectors_path, start_frame);
